...
const checks = [
  ...
  ['categories fall back to cookbook index', js.includes("fetchBuiltJson('index.json'") && js.includes('Promise.allSettled([') && js.includes('categories remain available from the cookbook index')],
